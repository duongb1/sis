...
VARIANTS = [
    {
        "name": "large_binary_cls",
        "experiment": "large_binary",
        "input_mode": "concat",
        "pooling": "cls",
        "lambda_aux": None,
        "metrics_folder": "large_binary",
    },
    {
        "name": "large_multiclass_cls",
        "experiment": "large_multiclass",
        "input_mode": "concat",
        "pooling": "cls",
        "lambda_aux": None,
        "metrics_folder": "large_multiclass",
    },
    {
        "name": "large_binary_attnpool",
        "experiment": "large_binary",
        "input_mode": "concat",
        "pooling": "attention",
        "lambda_aux": None,
    ...
    {
        "name": "large_multitask_cls_aux_0_5",
    ...
    {
        "name": "large_multitask_attnpool_aux_0_5",
        "experiment": "large_multitask",
        "input_mode": "concat",
        "pooling": "attention",
        "lambda_aux": 0.5,
...
def parse_args():
    parser = argparse.ArgumentParser(description="Compare default large SIS text models with the 5-fold mcstrat protocol.")
    parser.add_argument("--excel-root", default="/kaggle/input/datasets/duongbui/siscth")
    parser.add_argument("--output-dir", default="/kaggle/working/sis_excel_5fold_large_compare_mcstrat")
...
def main():
    ...
    print("Large comparison:", flush=True)
    print("- large_binary_cls", flush=True)
    print("- large_multiclass_cls", flush=True)
